...
enum MimeType: string implements Contract\MimeType
{
	 ...
	 * @return \Elephox\Support\Contract\MimeType
	 */
	public static function fromFile(mixed $file): Contract\MimeType
	{
	...
	public static function fromFileExtension(string $filename): Contract\MimeType
	{
		$extension = pathinfo($filename, PATHINFO_EXTENSION);
		if (empty($extension)) {
			return self::Applicationoctetstream;
		}
		...
		$mimeType = match ($extension) {
			...
			default => throw new RuntimeException("Unable to determine mime type of file at " . $filename),
		};

		return MimeType::tryFrom($mimeType) ?? new CustomMimeType($mimeType);
	}
}
