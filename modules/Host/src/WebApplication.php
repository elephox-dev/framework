...
use Elephox\Host\Middleware\FallbackResponseCreator;
use Elephox\Host\Middleware\ProcessingTimeHeader;
use Elephox\Host\Middleware\RequestRouter;
...
class WebApplication
{
	...
	public static function createBuilder(): WebApplicationBuilder
	{
		...
		$pipeline->push(new FallbackResponseCreator());
	...
	{
		$this->services
			->requireService(RequestPipelineBuilder::class)
			->push(new RequestRouter())
		;
	}
